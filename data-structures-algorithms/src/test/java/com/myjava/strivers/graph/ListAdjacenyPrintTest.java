...
public class ListAdjacenyPrintTest {
	@Test
	public void test1() {
		int[][] arr = new int[][] { { 2, 1 }, { 2, 0 } };
		int[][] result = ListAdjacenyPrint.printAdjacency(arr, 3);
		int[][] expected = new int[][] { { 0, 2 }, { 1, 2 }, { 2, 0, 1 } }; // it can be 2,1,0 as well
	...
	public void test3() {
		...
		int[][] result = ListAdjacenyPrint.printAdjacency(arr, 8);

...
public class DetectCycleUndirectedGraphTest {
	...
	public void test2() {
		...
		assertTrue(DetectCycleUndirectedGraph.detectCycle(list, 6));
	}
	...
	public void test3() {
		...
		assertTrue(DetectCycleUndirectedGraph.detectCycle(list, 4));
	}
}

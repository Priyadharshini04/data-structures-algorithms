...
public class LongestSubArrayTest {
	...
	@Test
	public void test2() {
		assertEquals(4, LongestSubArray.findLongBetter(new int[] { 1, 2, 1, 1, 1, 1, 1 }, 4));
		assertEquals(1, LongestSubArray.findLongBetter(new int[] { 1, 2, 1, 3 }, 2));
		assertEquals(21, LongestSubArray.findLongBetter(new int[] { 0, 2, 5, 3, 3, 4, 4, 3, 0, 5, 5, 4, 4, 4, 3, 2, 0,
				2, 3, 1, 3, 0, 4, 3, 1, 4, 5, 2, 4, 3, 1, 4, 5, 0, 3, 4, 0 }, 52));
		...
		assertEquals(19,
				LongestSubArray.findLongBetter(new int[] { 3, 2, 2, 0, 1, 2, 1, 0, 1, 0, 3, 3, 5, 4, 5, 4, 5, 1, 4, 1,
						3, 1, 1, 4, 3, 2, 3, 2, 0, 0, 1, 2, 4, 5, 0, 1, 0, 2, 2, 0, 3, 1, 0, 0, 3, 5, 4, 4, 3, 3, 4, 3,
						0, 3, 4, 1, 1, 0, 0, 2 }, 28));
	...
	public void test3() {
		...
		assertEquals(21, LongestSubArray.findLongOpti(new int[] { 0, 2, 5, 3, 3, 4, 4, 3, 0, 5, 5, 4, 4, 4, 3, 2, 0, 2,
				3, 1, 3, 0, 4, 3, 1, 4, 5, 2, 4, 3, 1, 4, 5, 0, 3, 4, 0 }, 52));
		...
		assertEquals(19,
				LongestSubArray.findLongOpti(new int[] { 3, 2, 2, 0, 1, 2, 1, 0, 1, 0, 3, 3, 5, 4, 5, 4, 5, 1, 4, 1, 3,
						1, 1, 4, 3, 2, 3, 2, 0, 0, 1, 2, 4, 5, 0, 1, 0, 2, 2, 0, 3, 1, 0, 0, 3, 5, 4, 4, 3, 3, 4, 3, 0,
						3, 4, 1, 1, 0, 0, 2 }, 28));
	...
	public void test4() {
		...
		assertEquals(21, LongestSubArray.longestSubarrayWithSumK(new int[] { 0, 2, 5, 3, 3, 4, 4, 3, 0, 5, 5, 4, 4, 4,
				3, 2, 0, 2, 3, 1, 3, 0, 4, 3, 1, 4, 5, 2, 4, 3, 1, 4, 5, 0, 3, 4, 0 }, 52));
//		assertEquals(6, LongestSubArray.longestSubarrayWithSumK(new int[] { -1, 0, 1, 1, -1, -1, 0 }, 0));
		...
		assertEquals(19,
				LongestSubArray.longestSubarrayWithSumK(new int[] { 3, 2, 2, 0, 1, 2, 1, 0, 1, 0, 3, 3, 5, 4, 5, 4, 5,
						1, 4, 1, 3, 1, 1, 4, 3, 2, 3, 2, 0, 0, 1, 2, 4, 5, 0, 1, 0, 2, 2, 0, 3, 1, 0, 0, 3, 5, 4, 4, 3,
						3, 4, 3, 0, 3, 4, 1, 1, 0, 0, 2 }, 28));
